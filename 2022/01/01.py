...
def get_max_calorines(list, limit):
    calorines = 0;
    for cal in list:
        if cal < limit and cal >= calorines:
            calorines = cal
...
def puzzle2(list):
    ...
    sec_max_cal = get_max_calorines(list, max_cal)
    third_max_cal = get_max_calorines(list, sec_max_cal)
...
calorines_list = get_elf_calorines_count()
#puzzle1(calorines_list)
puzzle2(calorines_list)